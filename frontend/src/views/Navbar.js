    ...
    <div>
        ...
        <div class="container-fluid">
          <a class="navbar-brand" href="./">
            <img style={{width:"50px", padding:"6px"}} src="https://s3-eu-west-1.amazonaws.com/tpd/logos/60ccee1913caf800019d4e4d/0x0.png" alt="" />
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            ...
            {token !== null && 
              <>
                ...
                <li class="nav-item">
                  <Link class="nav-link" to="/ask-mistral"> <i className='fas fa-envelope'></i> JobBot</Link>
                </li>
                <li class="nav-item">
