                ...
                <div className="py-2 px-4 border-bottom d-none d-lg-block">
                  <div className="d-flex align-items-center py-1">
                    ...
                    <div className="flex-grow-1 pl-3">
                      <strong>Assistant de bienvenue</strong>
                  ...
                  <div className="chat-messages p-4">
                    <div className="chat-message-right pb-4">
                      ...
                      <div className="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
                        ...
                        Bonjour! Je suis un millitaire en reconversion professionnel.
                      </div>
                    </div>
                    <div className="chat-message-left pb-4">
                      ...
                      <div className="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                        <div className="font-weight-bold mb-1">Assistant de bienvenue</div>
                        Bonjour ! Vous pouvez discuter en temps réel ici avec les membres de l'association ou bien commencer à vous entrainer pour vos entretient d'embauche.
                      </div>
                    </div>
                    ...
                    <div className="chat-message-left pb-4">
                      ...
                      <div className="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                        <div className="font-weight-bold mb-1">Assistant de bienvenue</div>
                        Allez dans la partie JobBot de la barre de navigation pour commencer à discuter avec moi !
                      </div>
                    </div>
                  </div>
                </div>
